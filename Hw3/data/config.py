...
hw_dataset = dataset_base.copy({
  'name': 'hw_dataset',
  'train_info': './data/hw_dataset/train/pascal_train.json',
  'train_images': './data/hw_dataset/train/images/',
  'valid_info': './data/hw_dataset/train/pascal_train.json',
  'valid_images': './data/hw_dataset/train/images/',
  'class_names': PASCAL_CLASSES,
...
yolact_resnet50_hw_config = yolact_resnet50_config.copy({
    'name': 'yolact_plus_resnet50_hw',
    # Dataset stuff
    'dataset': hw_dataset,
    'num_classes': len(hw_dataset.class_names) + 1,
