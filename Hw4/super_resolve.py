...
def visualize_sr(img, halve=False):
    ...
    """
    save_img_srresnet ="./output_srresnet/"+img
    save_img_srgan ="./output_srgan/"+img 
    Img =  "./testing_lr_images/"+img
    ...
    #                            Image.LANCZOS)
    # lr_img = lr_img.resize((int(lr_img.width / 4), int(lr_img.height / 4)),
    #                        Image.BICUBIC)
    

    # Bicubic Upsampling
    bicubic_img = lr_img.resize((lr_img.width, lr_img.height), Image.BICUBIC)
    # bicubic_img.show()
    ...
    sr_img_srresnet = sr_img_srresnet.resize((lr_img.width*3, lr_img.height*3))
    sr_img_srresnet.save(save_img_srresnet)
    ...
    sr_img_srgan = sr_img_srgan.resize((lr_img.width*3, lr_img.height*3))
    sr_img_srgan.save(save_img_srgan)

    # sr_img_srgan.show()
    # Create grid
    margin = 40
    grid_img = Image.new('RGB', (2 * lr_img.width + 3 * margin, 2 * lr_img.height + 3 * margin), (255, 255, 255))
    ...
    # grid_img.paste(lr_img, (2 * margin + bicubic_img.width, 2 * margin + sr_img_srresnet.height))
    # text_size = font.getsize("Original LR")
...
if __name__ == '__main__':
    grid_img = visualize_sr("00.png")
    grid_img = visualize_sr("01.png")
    grid_img = visualize_sr("02.png")
    grid_img = visualize_sr("03.png")
    grid_img = visualize_sr("04.png")
    grid_img = visualize_sr("05.png")
    grid_img = visualize_sr("06.png")
    grid_img = visualize_sr("07.png")
    grid_img = visualize_sr("08.png")
    grid_img = visualize_sr("09.png")
    grid_img = visualize_sr("10.png")
    grid_img = visualize_sr("11.png")
    grid_img = visualize_sr("12.png")
    grid_img = visualize_sr("13.png")
